...
public class PsUsers {
    ...
    public String toString(){
        ...
        re.append(", user_pwd = ").append(getUserPwd());
        re.append(", user_company = ").append(getUserCompany());
        re.append(", user_email = ").append(getUserEmail());
        re.append(", user_phone_number = ").append(getUserPhoneNumber());
        re.append(", user_little_name = ").append(getUserLittleName());
        re.append(", user_real_name = ").append(getUserRealName());
        re.append(", user_qq = ").append(getUserQq());
        re.append(", user_register_time = ").append(getUserRegisterTime().toString());
        re.append(", user_state = ").append(getUserState());
        re.append(", user_download_number = ").append(getUserDownloadNumber());
        re.append(", user_upload_number = ").append(getUserUploadNumber());
        re.append(", user_head_image = ").append(getUserHeadImage());
        re.append("]");
        return re.toString();
    }
}